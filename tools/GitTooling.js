...
foam.POM({
  ...
  tasks: {
    getFOAMRevision: ['gen-foam-revision', 'Extract FOAM git hash.', [], function getFOAMRevision() {
      try {
    ...
    getProjectRevision: ['gen-project-revision', 'Extract project git hash.', [], function getProjectRevision() {
      try {
...
// getBranchVersion: ['git-branch-version', 'Extract possible version string from branch name. ex. Release-v3.36.3 -> 3.36.3', [], function gitBranchVersion() {
