...
foam.CLASS({
  ...
  requires: [
    'foam.lang.internal.PropertySlot'
  ],
  ...
  methods: [
    ...
    */
    function installInClass(c, superProp, existingProp) {
      ...
      if ( superProp && foam.lang.Property.isInstance(superProp) ) {
      ...
      //   // For example foam.lang.String has foam.lang.String axioms for things
      //   // like "label"
      ...
      // if (
      //   c.id !== 'foam.lang.Property' &&
      //   c.id !== 'foam.lang.Model'    &&
      //   c.id !== 'foam.lang.Method'   &&
      //   c.id !== 'foam.lang.FObject'  &&
      //   this.cls_.id !== 'foam.lang.FObject'
      // ) {
    ...
    */
    ...
    function toSlot(obj) {
      ...
      if ( ! slot ) {
        slot = foam.lang.internal.PropertySlot.create();
        slot.obj  = obj;
        slot.prop = this;
