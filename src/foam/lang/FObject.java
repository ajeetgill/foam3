  ...
  extends Appendable, ContextAware, Comparable, Freezable, Hashable, Signable, Validatable
{
  ...
  foam.lang.MethodInfo APPEND = new foam.lang.MethodInfo(){
    @Override
  ...
  foam.lang.MethodInfo COPY_FROM = new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "copyFrom";
    }
    @Override
    public Object call(foam.lang.X x, Object receiver, Object[] args){
      return ((FObject)receiver).copyFrom((foam.lang.FObject)(args[0]));
    }
  };

  foam.lang.MethodInfo FCLONE = new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "fclone";
    }
  ...
  foam.lang.MethodInfo DEEP_CLONE = new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "deepClone";
    }
  ...
  foam.lang.MethodInfo SHALLOW_CLONE = new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "shallowClone";
    }
  ...
  foam.lang.MethodInfo DIFF = new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "diff";
    }
    @Override
    public Object call(foam.lang.X x, Object receiver, Object[] args){
      return ((FObject)receiver).diff((foam.lang.FObject)(args[0]));
    }
  };

  foam.lang.MethodInfo HARD_DIFF = new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "hardDiff";
    }
    @Override
    public Object call(foam.lang.X x, Object receiver, Object[] args){
      return ((FObject)receiver).hardDiff((foam.lang.FObject)(args[0]));
    }
  };

  foam.lang.MethodInfo SET_PROPERTY = new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "setProperty";
    }
  ...
  foam.lang.MethodInfo GET_PROPERTY = new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "getProperty";
    }
  ...
  foam.lang.MethodInfo IS_PROPERTY_SET = new foam.lang.MethodInfo(){
    @Override
    public String getName(){
  ...
  foam.lang.MethodInfo HAS_DEFAULT_VALUE = new foam.lang.MethodInfo(){
    @Override
    public String getName(){
  ...
  foam.lang.MethodInfo COMPARE_TO =     new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "compareTo";
    }
  ...
  foam.lang.MethodInfo VALIDATE =     new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "validate";
    }
    @Override
    public Object call(foam.lang.X x, Object receiver, Object[] args){
      ((FObject)receiver).validate((foam.lang.X)(args[0]));
      return null;
    }
  };

  foam.lang.MethodInfo VERIFY = new foam.lang.MethodInfo() {
    @Override
    public String getName(){
      return "verify";
    }
  ...
  foam.lang.MethodInfo BEFORE_FREEZE =     new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "beforeFreeze";
    }
  ...
  foam.lang.MethodInfo HASH =     new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "hash";
    }
  ...
  foam.lang.MethodInfo SIGN =     new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "sign";
    }
  ...
  foam.lang.MethodInfo TO_JSON =     new foam.lang.MethodInfo(){
    @Override
    public String getName(){
      return "toJSON";
    }
  ...
  foam.lang.ClassInfo classInfo_ = new foam.lang.ClassInfoImpl()
    .setId("foam.lang.FObject").setObjClass(foam.lang.FObject.class)
  ...
  static foam.lang.ClassInfo getOwnClassInfo() {
    return classInfo_;
  }
  ...
  default FObject overlay_(FObject obj, java.util.Set visited) {
    ...
    for ( PropertyInfo p : props ) {
      ...
      try {
        ...
        // foam.core.logger.StdoutLogger.instance().warning("FObject.overlay remote", obj.getClass().getSimpleName(), "isSet/get", p.getName(), "from", obj.getClass().getSimpleName(), e.getMessage());
        ...
        if ( p2 != null ) {
          ...
          try {
            ...
            foam.core.logger.StdoutLogger.instance().error("FObject.overlay remote", this.getClass().getSimpleName(), "isSet/get", p.getName(), "from", obj.getClass().getSimpleName(), ee.getMessage(), ee);
          }
        }
      }
      Object local = null;
      if ( p.isSet(obj) ) {
        try {
          ...
          // foam.core.logger.StdoutLogger.instance().warning("FObject.overlay local", this.getClass().getSimpleName(), "get", p.getName(), "from", this.getClass().getSimpleName(), e.getMessage());
        }
        if ( remote instanceof FObject &&
          ...
          try {
            ...
            // foam.core.logger.StdoutLogger.instance().warning("FObject.overlay local", this.getClass().getSimpleName(), "set", p.getName(), "overlay", remote.getClass().getSimpleName(), e.getMessage());
            p.set(this, remote);
          }
        } else {
          p.set(this, remote);
  ...
  default void validate(foam.lang.X x) {
