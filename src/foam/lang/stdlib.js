  ...
  methods: [
    ...
    function withArgs(fn, source, opt_self) {
      ...
      for ( var i = 0 ; i < argNames.length ; i++ ) {
        var a = foam.lang.FObject.isInstance(source) &&
...
foam.LIB({
  ...
  methods: [
    ...
    function compare(a, b) {
      if ( ! foam.lang.FObject.isInstance(b) ) return 1;
  ...
  methods: [
    ...
    function isInstance(o) {
      return typeof o === 'object' && ! Array.isArray(o) &&
          ! foam.lang.FObject.isInstance(o) && ! foam.Null.isInstance(o);
    },
    function shallowClone(o) {
      const newObj = {};
...
foam.typeOf = (function() {
  ...
  var tDate      = foam.Date;
  var tFObject   = foam.lang.FObject;
