...
foam.CLASS({
  ...
  if ( piiRequestObject.getViewRequestStatus().equals(foam.nanos.pii.PIIRequestStatus.DENIED)){
    return null;
  }

  if ( piiRequestObject.getViewRequestStatus().equals(foam.nanos.pii.PIIRequestStatus.APPROVED)){
