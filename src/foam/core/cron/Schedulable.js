  ...
  properties: [
    ...
    },
    {
      ...
      javaFactory: `
        ...
        Date d = getSchedule().getNextScheduledTime(foam.lang.XLocator.get(), from);
    ...
    },
    {
      ...
      factory: function() {
        ...
        if ( ! nextScheduledDate_ && this.endsOn < new Date() ) {
          return foam.core.auth.LifecycleState.DISABLED;
        } else if ( ! nextScheduledDate_ ) {
          return foam.core.auth.LifecycleState.PENDING;
        }
        return foam.core.auth.LifecycleState.ACTIVE;
      }
    },
    {
      name: 'lastRun',
  ...
  methods: [
    ...
    },
    {
      ...
      javaCode: `
        ...
        setStatus(foam.core.script.ScriptStatus.UNSCHEDULED);
    ...
    },
    {
      ...
      javaCode: `
        try {
          foam.lang.FObject obj = getObjectToSchedule();
          ...
          ((foam.dao.DAO) x.get("alarmDAO")).put(new Alarm.Builder(x)
            ...
            .setReason(foam.core.alarming.AlarmReason.UNSPECIFIED)
