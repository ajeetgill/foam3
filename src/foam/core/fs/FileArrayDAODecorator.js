...
foam.CLASS({
  ...
  methods: [
    ...
    async function processFiles(obj) {
      ...
      if ( foam.core.crunch.document.Document.isInstance(obj) ) {
      ...
      var props2 = obj.cls_.getAxiomsByClass(foam.lang.FObjectProperty).filter((p) => ! foam.dao.DAOProperty.isInstance(p));
