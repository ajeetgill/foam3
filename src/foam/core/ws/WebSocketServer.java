  ...
  implements foam.lang.ContextAware
{
  ...
  protected foam.core.box.COREServiceRouter router_ = null;

  protected foam.core.box.COREServiceRouter getRouter() {
    if ( router_ == null ) {
      router_ = getX().create(foam.core.box.COREServiceRouter.class);
    }
