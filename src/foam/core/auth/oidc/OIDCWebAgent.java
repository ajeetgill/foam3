...
import foam.core.auth.oidc.OIDCProvider;
import foam.core.auth.oidc.OIDCLoginState;
...
public class OIDCWebAgent implements WebAgent {
    ...
    public void execute(X x) {
        ...
        try {
            ...
            foam.core.session.Session session = (foam.core.session.Session)((foam.dao.DAO)x.get("sessionDAO")).find(state.getSessionId());
            if ( session == null ) {
