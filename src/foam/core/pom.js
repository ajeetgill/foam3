...
foam.POM({
  ...
  javaFiles: [
    { name: "benchmark/DateFormatBenchmark",                          flags: "test" },
    { name: "benchmark/JournalReplayBenchmark",                       flags: "test" },
    { name: "benchmark/LoggingBenchmark",                             flags: "test" },
    { name: "benchmark/JSONOutputterEscapeBenchmark",                 flags: "test" },
    { name: "benchmark/FUIDBenchmark",                                flags: "test" },
    { name: "benchmark/TimestampBenchmark",                           flags: "test" },
    { name: "benchmark/JSONOutputterBenchmark",                       flags: "test" },
    { name: "benchmark/JSONUtilEscapeBenchmark",                      flags: "test" },
    { name: "benchmark/PMBenchmark",                                  flags: "test" },
    { name: "benchmark/F3FileJournalBenchmark",                       flags: "test" },
    { name: "benchmark/JSONFormatterBenchmark",                       flags: "test" },
    { name: "benchmark/F3JournalReplayBenchmark",                     flags: "test" },
    { name: "benchmark/FileJournalBenchmark",                         flags: "test" },
    { name: "pm/DAOPMLogger" },
    ...
    { name: "ws/NanoWebSocketServer" },
    { name: "ws/NanoWebSocket" },
    { name: "ws/WebSocketServer" },
