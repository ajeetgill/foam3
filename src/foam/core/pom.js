...
foam.POM({
  ...
  files: [
    ...
    { name: "benchmark/DateFormatBenchmark",                          flags: "test&js|java" },
    { name: "benchmark/JournalReplayBenchmark",                       flags: "test&js|java" },
    { name: "benchmark/LoggingBenchmark",                             flags: "test&js|java" },
    { name: "benchmark/JSONOutputterEscapeBenchmark",                 flags: "test&js|java" },
    { name: "benchmark/FUIDBenchmark",                                flags: "test&js|java" },
    { name: "benchmark/TimestampBenchmark",                           flags: "test&js|java" },
    { name: "benchmark/JSONOutputterBenchmark",                       flags: "test&js|java" },
    { name: "benchmark/JSONUtilEscapeBenchmark",                      flags: "test&js|java" },
    { name: "benchmark/PMBenchmark",                                  flags: "test&js|java" },
    { name: "benchmark/F3FileJournalBenchmark",                       flags: "test&js|java" },
    { name: "benchmark/JSONFormatterBenchmark",                       flags: "test&js|java" },
    { name: "benchmark/F3JournalReplayBenchmark",                     flags: "test&js|java" },
    { name: "benchmark/FileJournalBenchmark",                         flags: "test&js|java" }
  ],
  ...
  javaFiles: [
    ...
    { name: "app/HealthWebAgent" },
    { name: "app/VersionWebAgent" },
