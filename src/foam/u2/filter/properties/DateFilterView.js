...
foam.CLASS({
  ...
  messages: [
    ...
    { name: 'LABEL_BETWEEN_INCLUSIVE',    message: 'Between (Inclusive)' }
  ],
  ...
  properties: [
    ...
    },
    {
      ...
      `,
      preSet: function(o, n) {
        if ( this.isSetFromPredicate || this.qualifier === 'BtInclusive' )
          return n;
        var n1 = new Date(n);
    ...
    },
    {
      ...
      expression: function(qualifier, date1, date2) {
        ...
        if ( qualifier !== 'Bt' && qualifier !== 'BtInclusive' ) {
  ...
  methods: [
      ...
      this.addClass()
        .start(this.ChoiceView, {
              ...
              choices: [
                ...
                ['BtInclusive', this.LABEL_BETWEEN_INCLUSIVE]
              ],
              defaultValue: 'True'
            })
        ...
        .add(this.onDetach(this.slot(function(qualifier) {
          ...
          return qualifier === 'Bt' || qualifier === 'BtInclusive' ?
    ...
    function restoreFromPredicate(predicate) {
      ...
      if ( qualifier == 'And' ) {
        // Check if it's inclusive (Gte/Lte) or exclusive (Gt/Lt)
        var isInclusive = predicate.args[0].cls_.name === 'Gte' &&
                          predicate.args[1].cls_.name === 'Lte';
        this.qualifier = isInclusive ? 'BtInclusive' : 'Bt';
