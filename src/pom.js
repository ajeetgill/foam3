...
foam.POM({
  ...
  files: [
    ...
    { name: "foam/lang/FOAMExceptionTest",                            flags: "js|java" },
    ...
    { name: "foam/core/u2/navigation/IFrameTopNavigation",           flags: "web" },
...
//    { name: "foam/version/VersionedClassFactory",                     flags: "js" },
    ...
    { name: "foam/dao/TimeSegmentedJournalDAO",                       flags: "js|java" },
...
//    { name: "lib/fcm",                                                flags: "node" },
    ...
    { name: "foam/core/menu/MenuToolBar",                            flags: "js" },
    ...
    { name: "foam/lang/FObjectTest",                                  flags: "js|java" },
    ...
    { name: "foam/core/column/ColumnConfigPropertyValue",            flags: "js|java" },
    { name: "foam/core/column/CommonColumnHandler",                  flags: "js" },
    { name: "foam/core/column/CSVTableOutputter",                    flags: "js" },
    { name: "foam/core/column/NestedPropertiesExpression",           flags: "js|java" },
    { name: "foam/core/column/TableColumnOutputter",                 flags: "js|java" },
    ...
    { name: "foam/core/fs/AgreementView",                            flags: "js" },
    ...
    { name: "foam/lang/FOAMExceptionTestTestException",               flags: "js|java" },
    ...
    { name: "foam/core/actioncommand/ActionCommand",                 flags: "js|java" },
    { name: "foam/core/session/LocalSettingSessionDAO",              flags: "js|java" },
    { name: "foam/core/session/SimpleSessionService",                flags: "js|java" },
    { name: "foam/core/pool/AbstractFixedThreadPool",                flags: "js|java" },
    { name: "foam/core/om/OMLogger",                                 flags: "js|java" },
    { name: "foam/core/google/api/sheets/GoogleSheetsApiService",    flags: "js|java" },
    ...
    { name: "foam/core/geocode/GoogleMapsAddressComponent",          flags: "js|java" },
    { name: "foam/core/geocode/GoogleMapsCoordinates",               flags: "js|java" },
    { name: "foam/core/geocode/GoogleMapsGeocodeResponse",           flags: "js|java" },
    { name: "foam/core/geocode/GoogleMapsGeocodeResult",             flags: "js|java" },
    { name: "foam/core/geocode/GoogleMapsGeometry",                  flags: "js|java" },
    { name: "foam/core/geocode/GoogleMapsBoundary",                  flags: "js|java" },
    { name: "foam/core/geocode/GoogleMapsAddressParser",             flags: "js|java" },
    { name: "foam/core/geocode/GoogleMapsPlacesPredictions",         flags: "js|java" },
    { name: "foam/core/geocode/GoogleMapsPlacesResponse",            flags: "js|java" },
    { name: "foam/core/demo/relationship/test/RelationshipTest",     flags: "js|java" },
    { name: "foam/core/fs/FileDataClearSink",                        flags: "js|java" },
    { name: "foam/core/fs/FileDataDAO",                              flags: "js|java" },
    { name: "foam/core/fs/FileUpdateDecorator",                      flags: "js|java" },
    { name: "foam/core/fs/TempFileDAO",                              flags: "js|java" },
    { name: "foam/core/dig/FieldNameMapGrammar",                     flags: "js|java" },
    { name: "foam/lib/query/TestModel",                               flags: "js|java" },
    { name: "foam/core/ruler/RulerData",                             flags: "js|java" },
    { name: "foam/core/actioncommand/ActionCommandDAO",              flags: "js|java" },
    { name: "foam/core/audit/AuditDAO",                              flags: "js|java" },
    { name: "foam/core/auth/email/EmailVerificationDAO",             flags: "js|java" },
    { name: "foam/dao/FreezingDAO",                                   flags: "js|java" },
    { name: "foam/core/geocode/GoogleMapsGeocodingDAO",              flags: "js|java" },
    { name: "foam/dao/history/HistoryDAO",                            flags: "js|java" },
    { name: "foam/dao/UnreliableDAO",                                 flags: "js|java" },
    { name: "foam/core/auth/UserPasswordHashingDAO",                 flags: "js|java" },
    { name: "foam/dao/ValidatingDAO",                                 flags: "js|java" },
    { name: "foam/core/test/StockSnapshot",                          flags: "js|java" },
    { name: "foam/core/analytics/FoldManager",                       flags: "js|java" },
    { name: "foam/core/analytics/FoldManagerDAODecorator",           flags: "js|java" },
    { name: "foam/core/analytics/DAOFoldManager",                    flags: "js|java" },
    { name: "foam/core/analytics/DAOReduceManager",                  flags: "js|java" },
    ...
    { name: "foam/core/cron/SimpleIntervalScheduleView",             flags: "web" },
